...
from src.ui.ui_components.connection_selection import radio_buttons_creation, get_custom_sap_system, get_fnwbc_system
from src.ui.ui_components.dialog_boxes import DialogBoxes
from src.ui.ui_components.forms import create_fiori_nwbc_form, create_custom_system_form
...
def system_modification_initial_tab(menu_frame):
    """
    Creates the initial tab of the system modification window.
    """
    # Clear the frame
    ...
    description_label = tk.Label(
        menu_frame,
        text="Warnings:\n\n"
             "1. This function will modify a sap system in your  SAP UI Landscape file    \n "
    ...
    next_button = tk.Button(menu_frame, text="Next", background="black", foreground="white", width=10,
                            height=2,
