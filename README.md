...
This repository won't be maintained for now, because of my lack of time and lack of knowledge and interest in ``tkinter``. This app was developed as my very first python project and has some major programming flaws, but it works fortunately well for its job. 
